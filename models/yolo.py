...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            if self.traced:
                if isinstance(m, Detect) or isinstance(m, IDetect) or isinstance(m, IDetect_Decoupled) or isinstance(m,
                                                                                                                     IAuxDetect) or isinstance(
                        m,
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
            ...
            if m in [DownC, SPPCSPC, GhostSPPCSPC,
                     ...
                     ST2CSPA, ST2CSPB, ST2CSPC,Convmix]:
        ...
        #     c2 = sum([ch[x] for x in f])
            ...
            c2 = ch[f] // 2
        elif m in [Detect, TSCODE_Detect, IDetect, IDetect_Decoupled, IAuxDetect, IBin, IKeypoint]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../cfg/deploy/yolov7-tiny-imp-4h-2concate.yaml', help='model.yaml')
