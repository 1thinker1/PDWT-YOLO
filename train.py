...
if __name__ == '__main__':
    try:
        ...
        parser.add_argument('--cfg', type=str, default='cfg/deploy/yolov7-tiny-imp-4h-2concate.yaml', help='model.yaml path')
        ...
        parser.add_argument('--batch-size', type=int, default=25, help='total batch size for all GPUs')
